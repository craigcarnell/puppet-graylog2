...
class graylog2 (
  ...
  $real_install_source = $graylog2::install_source ? {
    ''      => "${graylog2::params::base_url_default}/graylog2-server/releases/download/${graylog2::version}/graylog2-server-${graylog2::version}.tgz",
...
#    ''      => "http://download.graylog2.org/graylog2-server/graylog2-web-interface-${graylog2::version}.tar.gz",
    ''      => "${graylog2::params::base_url_default}/graylog2-web-interface/releases/download/${graylog2::version}/graylog2-web-interface-${graylog2::version}.tgz",
    default => $graylog2::install_source,
  }
